...
Este arquivo direciona cada área à sua fonte autoritativa. Leia somente os documentos necessários à tarefa.
...
A política de eficiência de tokens (AI-TOKEN-EFFICIENCY), o contrato de handoff por executor e as demais orientações a agentes ficam em `AGENTS.md`.
