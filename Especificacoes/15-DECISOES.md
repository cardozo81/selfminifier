...
- A versão atual é `0.2.2`, com `package.json` como autoridade única; nomes de pasta, ZIP e checksum são derivados dessa versão.
...
- A política segue SemVer; a versão pré-1.0 atual é `0.2.2`, derivada exclusivamente de `package.json`, formando pasta, ZIP e checksum. As tags `v0.2.0-rc.1`, `v0.2.0-rc.2` e `v0.2.0-rc.3` e os GitHub Releases `0.2.0-rc.1`, `0.2.0-rc.2` e `0.2.0-rc.3` já foram publicados como PRERELEASE.
